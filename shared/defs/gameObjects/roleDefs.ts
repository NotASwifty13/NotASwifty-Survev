...
export function mergeRoleOverride(base: RoleDef, override: Partial<RoleDef>): RoleDef {
    return {
        ...base,
        ...override,
        defaultItems: override.defaultItems
            ? util.mergeDeep(base.defaultItems ?? {}, override.defaultItems)
            : base.defaultItems,
    };
}

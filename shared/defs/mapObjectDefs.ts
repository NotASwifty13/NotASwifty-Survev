        ...
        mapObjects: [
            {
                ...
                instances: [{ pos: v2.create(-12, 6), ori: 0 }],
                scale: 1,
            },
            {
                type: "house_window_01",
                instances: [
                    { pos: v2.create(1, -19.25), ori: 1 },
                    { pos: v2.create(11, -19.25), ori: 1 },
                    { pos: v2.create(-1, 17.25), ori: 1 },
                ],
                scale: 1,
            },
            {
                type: "house_door_01",
                instances: [
                    { pos: v2.create(-5.25, -13.5), ori: 0 },
                    { pos: v2.create(17.25, -13.5), ori: 0 },
                    { pos: v2.create(17, -2.5), ori: 0 },
                    { pos: v2.create(17, 10.5), ori: 2 },
                    { pos: v2.create(12.5, 17.25), ori: 1},
                ],
                scale: 1,
            },
            {
                ...
                instances: [
                    { pos: v2.create(-2.5, -5), ori: 1 },
                    { pos: v2.create(6, -3.5), ori: 0 },
                    { pos: v2.create(6, 3.5), ori: 0 },
                    { pos: v2.create(8.5, 5), ori: 1 },
                ],
                scale: 1,
            },
            {
                ...
                instances: [
                    { pos: v2.create(4, -5), ori: 1 },
                    { pos: v2.create(15, 5), ori: 1 },
                ],
                scale: 1,
            },
            {
                type: "bank_wall_int_5",
                instances: [{ pos: v2.create(17, 4), ori: 0 }],
                scale: 1,
            },
            {
                type: "bank_wall_int_8",
                instances: [{ pos: v2.create(21.5, 4), ori: 1 }],
                scale: 1,
            },
            {
                type: "bank_window_01",
                instances: [
                    { pos: v2.create(6, 0), ori: 0 },
                    { pos: v2.create(1, -5), ori: 1 },
                    { pos: v2.create(12, 5), ori: 1 },
                ],
                scale: 1,
            },
            {
                type: "vending_01",
                instances: [{ pos: v2.create(4.5, -16.9), ori: 2 }],
                scale: 1,
            },
            {
                type: "stand_01",
                instances: [
                    { pos: v2.create(7.65, -17), ori: 2 },
                    { pos: v2.create(15, 15), ori: 3 },
                ],
                scale: 1,
            },
            {
                type: { toilet_01: 5, toilet_02: 1 },
                instances: [
                    { pos: v2.create(23.5, 0.5), ori: 3 },
                    { pos: v2.create(23.5, 7.5), ori: 3 }, 
                ],
                scale: 1,
            },
            {
                type: "fire_ext_01",
                instances: [{ pos: v2.create(4.5, 16.15), ori: 3 }],
                scale: 1,
            },
            {
                type: "bush_02",
                instances: [
                    { pos: v2.create(-2.5, -16.25), ori: 0 },
                    { pos: v2.create(14.5, -16.25), ori: 0 },
                ],
                scale: 1,
            ...
            {
                type: "crate_01",
                instances: [{ pos: v2.create(19.75, 13.75), ori: 0 }],
                scale: 0.9,
                inheritOri: false,
            },
            {
                type: "loot_tier_1",
                instances: [{ pos: v2.create(12, 0), ori: 0 }],
                scale: 1,
            },
            {
                type: { loot_tier_1: 1, "": 1 },
                instances: [{ pos: v2.create(1, 0), ori: 0 }],
                scale: 1,
            },
            {
                type: "tree_01",
                instances: [{ pos: v2.create(-16.5, -12.5), ori: 0 }],
                scale: 1.1,
            },
            {
                type: "barrel_01",
                instances: [{ pos: v2.create(-7.5, -7.25), ori: 0 }],
                scale: 0.85,
            },
            {
                type: "tree_01",
                instances: [
                    { pos: v2.create(21, -7), ori: 0 },
                    { pos: v2.create(21, -16.25), ori: 0 },
                ],
                scale: 0.55,
            },
        ],
        ...
        mapObjects: [
            {
                ...
                instances: [{ pos: v2.create(6.5, 3.5), ori: 2 }],
                scale: 1,
            },
            {
                type: {
                ...
                instances: [
                    { pos: v2.create(-12.3, 5), ori: 1 },
                    { pos: v2.create(-12.3, -5), ori: 1 },
                    {pos: v2.create(-8, 9.3), ori: 0 },
                    {pos: v2.create(-8, -9.3), ori: 2 },
                    {pos: v2.create(1, 9.3), ori: 0 },
                    {pos: v2.create(1, -9.3), ori: 2 },
                ],
                scale: 1,
            },
            {
                type: "crate_05",
                instances: [
                    { pos: v2.create(-3.5, 6.5), ori: 0 },
                    { pos: v2.create(-3.5, -6.5), ori: 2 },
                ],
                scale: 1,
            },
            {
                type: {[e.floor_loot || "loot_tier_vault_floor"]: 1 },
                instances: [{ pos: v2.create(-3.5, 0), ori: 0 }],
                scale: 1,
            },
        ],
    };
